...
//   const allFunctionalities = ["Manage Vendors", "View Fleet Status", "Assign Roles", "Manage City Vendors", "Onboard Drivers", "Manage Fleet", "Deploy Tasks", "View Tasks"]; // Add more functionalities as needed
...
//       {selectedRole && (
//         <div className="mt-4">
//           <h3 className="text-lg font-semibold mb-2">Permissions for {selectedRole}</h3>
