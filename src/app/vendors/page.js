...
//       (user?.role === 'Local Vendor' && (vendor.level === 'DeployAssociate' || vendor.level === 'Local'))
//     );
//   };

//   const canDelete = (vendor) => {
//     return (
//       (user?.role === 'Super Vendor' && vendor.level !== 'Super') ||
//       (user?.role === 'Regional Vendor' && vendor.level !== 'Super' && vendor.level !== 'Regional') ||
//       (user?.role === 'City Vendor' && (vendor.level === 'Local' || vendor.level === 'DeployAssociate')) ||
...
//         Welcome {user?.name}! You  have access to the sub-roles of {user?.role}.
//       </Label>
